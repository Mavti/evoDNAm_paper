...
cebpa_cpg <-
  plot_grid(
    pl_CEBPA_human[[1]] + coord_cartesian(ylim = c(0.0071, 0.02))+ theme(axis.line = element_line()),
    pl_CEBPA_Macaque[[1]] + coord_cartesian(ylim = c(0.0071, 0.02))+ theme(axis.line = element_line(), axis.text.y=element_blank()),
    pl_CEBPA_Mouse[[1]] + coord_cartesian(ylim = c(0.0071, 0.02))+ theme(axis.line = element_line(), axis.text.y=element_blank()),
    pl_CEBPA_Rat[[1]] + coord_cartesian(ylim = c(0.0071, 0.02))+ theme(axis.line = element_line(), axis.text.y=element_blank()),
    pl_CEBPA_Dog[[1]] + coord_cartesian(ylim = c(0.0071, 0.02))+ theme(axis.line = element_line(), axis.text.y=element_blank()),
    nrow = 1
  )
y.grob <- textGrob("CEBPA", 
                   gp=gpar( fontsize=18), rot=90)
cebpa_cpg <- grid.arrange(arrangeGrob(cebpa_cpg, left = y.grob))



hnf4a_cpg <- plot_grid(
  pl_HNF4a_human[[1]] + coord_cartesian(ylim = c(0.014, 0.034)) + theme(plot.title = element_blank(),axis.line = element_line()),
  pl_HNF4a_Macaque[[1]] + coord_cartesian(ylim = c(0.014, 0.034))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_HNF4a_Mouse[[1]] + coord_cartesian(ylim = c(0.015, 0.034))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_HNF4a_Rat[[1]] + coord_cartesian(ylim = c(0.014, 0.034))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_HNF4a_Dog[[1]] + coord_cartesian(ylim = c(0.014, 0.034))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  nrow = 1
)

y.grob <- textGrob("HNF4A", 
                   gp=gpar( fontsize=18), rot=90)
hnf4a_cpg <- grid.arrange(arrangeGrob(hnf4a_cpg, left = y.grob))

hnf6_cpg <- plot_grid(
  pl_HNF6_human[[1]] + coord_cartesian(ylim = c(0.012, 0.028))+ theme(plot.title = element_blank(),axis.line = element_line()),
  pl_HNF6_Macaque[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_HNF6_Mouse[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_HNF6_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  NULL,
  nrow = 1
)
y.grob <- textGrob("HNF6", 
                   gp=gpar(fontsize=18), rot=90)
hnf6_cpg <- grid.arrange(arrangeGrob(hnf6_cpg, left = y.grob))

foxa1_cpg <- plot_grid(
  pl_FoxA1_human[[1]] + coord_cartesian(ylim = c(0.013, 0.025))+ theme(plot.title = element_blank(),axis.line = element_line()),
  NULL,
  pl_FoxA1_Mouse[[1]] + coord_cartesian(ylim = c(0.013, 0.025)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_FoxA1_Rat[[1]] + coord_cartesian(ylim = c(0.013, 0.025)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_FoxA1_Dog[[1]] + coord_cartesian(ylim = c(0.013, 0.025)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  nrow = 1
  
)

y.grob <- textGrob("ONECUT1", 
                   gp=gpar(fontsize=18), rot=90)
foxa1_cpg <- grid.arrange(arrangeGrob(foxa1_cpg, left = y.grob))

ctcf_cpg <- plot_grid(
  pl_CTCF_human[[1]] + coord_cartesian(ylim = c(0.012, 0.040))+ theme(plot.title = element_blank(),axis.line = element_line()),
  pl_CTCF_Macaque[[1]] + coord_cartesian(ylim = c(0.012, 0.040))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_CTCF_Mouse[[1]] + coord_cartesian(ylim = c(0.012, 0.040))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_CTCF_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.040)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_CTCF_Dog[[1]] + coord_cartesian(ylim = c(0.012, 0.040)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  nrow = 1
)
y.grob <- textGrob("CTCF", 
                   gp=gpar( fontsize=18), rot=90)
ctcf_cpg <- grid.arrange(arrangeGrob(ctcf_cpg, left = y.grob))

random_cpg <- plot_grid(
  pl_random_Human[[1]] + coord_cartesian(ylim = c(0.006, 0.020)) + theme(plot.title = element_blank(),axis.line = element_line()),
  pl_random_Macaque[[1]] + coord_cartesian(ylim = c(0.006, 0.020))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_random_Mouse[[1]] + coord_cartesian(ylim = c(0.006, 0.020))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_random_Rat[[1]] + coord_cartesian(ylim = c(0.006, 0.020)) + theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  pl_random_Dog[[1]] + coord_cartesian(ylim = c(0.006, 0.020))+ theme(plot.title = element_blank(),axis.line = element_line(), axis.text.y=element_blank()),
  nrow = 1
  
)
y.grob <- textGrob("Random", 
                   gp=gpar(fontsize=18), rot=90)
random_cpg <- grid.arrange(arrangeGrob(random_cpg, left = y.grob))
    
#

cpg_profiles <- plot_grid( cebpa_cpg,ctcf_cpg, hnf4a_cpg, hnf6_cpg,foxa1_cpg, random_cpg, 
                           ncol=1)
cpg_profiles

ggsave(plot = cpg_profiles, filename = "/nfs/research/flicek/user/rimoldi/Projects/EDM/Figures/CpGfreqProfiles_allSpeciesAllTFs.pdf",width=198, height = 143, units = "mm")
...
```{r fig.width=15,fig.height=15, echo=F}

cebpa_meth <-
  plot_grid(
    pl_CEBPA_human[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(),axis.line = element_line(),axis.text.x = element_blank()),
    pl_CEBPA_Macaque[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(),axis.line = element_line(),axis.text = element_blank()),
    pl_CEBPA_Mouse[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(),axis.line = element_line(),axis.text = element_blank()),
    pl_CEBPA_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(),axis.line = element_line(),axis.text = element_blank()),
    pl_CEBPA_Dog[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(),axis.line = element_line(),axis.text = element_blank()),
    nrow = 1
  )
y.grob <- textGrob("CEBPA", 
                   gp=gpar( fontsize=18), rot=90)
cebpa_meth <- grid.arrange(arrangeGrob(cebpa_meth, left = y.grob))

hnf4a_meth <- plot_grid(
  pl_HNF4a_human[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text.x = element_blank()),
  pl_HNF4a_Macaque[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_HNF4a_Mouse[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_HNF4a_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_HNF4a_Dog[[2]]+coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  nrow = 1
)

y.grob <- textGrob("HNF4A", 
                   gp=gpar( fontsize=18), rot=90)
hnf4a_meth <- grid.arrange(arrangeGrob(hnf4a_meth, left = y.grob))

hnf6_meth <- plot_grid(
  pl_HNF6_human[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text.x = element_blank()),
  pl_HNF6_Macaque[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_HNF6_Mouse[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_HNF6_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  NULL,
  nrow = 1
)
y.grob <- textGrob("HNF6", 
                   gp=gpar(fontsize=18), rot=90)
hnf6_meth <- grid.arrange(arrangeGrob(hnf6_meth, left = y.grob))

foxa1_meth <- plot_grid(
  pl_FoxA1_human[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text.x = element_blank()),
  NULL,
  pl_FoxA1_Mouse[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_FoxA1_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_FoxA1_Dog[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  nrow = 1
...
y.grob <- textGrob("ONECUT1", 
                   gp=gpar(fontsize=18), rot=90)
foxa1_meth <- grid.arrange(arrangeGrob(foxa1_meth, left = y.grob))

ctcf_meth <- plot_grid(
  pl_CTCF_human[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text.x = element_blank()),
  pl_CTCF_Macaque[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_CTCF_Mouse[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_CTCF_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_CTCF_Dog[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  nrow = 1
)

y.grob <- textGrob("CTCF", 
                   gp=gpar(fontsize=18), rot=90)
ctcf_meth <- grid.arrange(arrangeGrob(ctcf_meth, left = y.grob))

random_meth <- plot_grid(
  pl_random_Human[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text.x = element_blank()),
  pl_random_Macaque[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_random_Mouse[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_random_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(), plot.title = element_blank(),axis.line = element_line(),axis.text = element_blank()),
  pl_random_Dog[[2]] +coord_cartesian(ylim = c(10,90)) + theme(axis.title=element_blank(),axis.text = element_blank(),plot.title = element_blank(),axis.line = element_line()),
  nrow = 1
  
)
y.grob <- textGrob("Random", 
                   gp=gpar(fontsize=18), rot=90)
random_meth <- grid.arrange(arrangeGrob(random_meth, left = y.grob))
    
#

meth_profiles <- plot_grid( cebpa_meth, ctcf_meth, hnf4a_meth, hnf6_meth,foxa1_meth, random_meth, 
                           ncol=1)
meth_profiles

ggsave(plot = meth_profiles, filename = "/nfs/research/flicek/user/rimoldi/Projects/EDM/Figures/MethProfiles_allSpeciesAllTFs.pdf",width=199, height = 132, units = "mm")
...
rat_meth <-
  plot_grid(
    pl_CEBPA_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme( plot.title = element_blank(), axis.title = element_blank() ),
    pl_HNF4a_Rat[[2]] +coord_cartesian(ylim = c(10,90)) + theme( plot.title = element_blank(), axis.title = element_blank()),
    pl_HNF6_Rat[[2]] +coord_cartesian(ylim = c(10,90))+ theme( plot.title = element_blank(), axis.title = element_blank()),
    pl_FoxA1_Rat[[2]] +coord_cartesian(ylim = c(10,90))+ theme( plot.title = element_blank(), axis.title = element_blank()),
    pl_CTCF_Rat[[2]] + coord_cartesian(ylim = c(10,90))+ theme( plot.title = element_blank(), axis.title = element_blank()),
    pl_random_Rat[[2]]+coord_cartesian(ylim = c(10,90))+ theme( plot.title = element_blank(), axis.title = element_blank()),
    nrow = 1
  )

rat_cpg <-
  plot_grid(
    pl_CEBPA_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank()) ,
    pl_HNF4a_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank()),
    pl_HNF6_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank()),
    pl_FoxA1_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank()),
    pl_CTCF_Rat[[1]] + coord_cartesian(ylim = c(0.012, 0.028)) + theme(plot.title = element_blank()),
    pl_random_Rat[[1]] + coord_cartesian(ylim = c(0.007, 0.028)) + theme(plot.title = element_blank()),
    nrow = 1
  )



Rat_cpgAndmeth_profiles <- plot_grid( rat_cpg, rat_meth, ncol=1)
Rat_cpgAndmeth_profiles

ggsave(plot = Rat_cpgAndmeth_profiles, filename = "/nfs/research/flicek/user/rimoldi/Projects/EDM/Figures/Rat_MethAndCpGfreqProfiles.pdf",width=15, height = 8)
...
macaque_enh <- read.table("/nfs/research/flicek/user/rimoldi/Projects/EDM/Revisions/Enhancers_avgProfiles/Macaque_Liver_MethMatrix.txt")
mouse_enh <- read.table("/nfs/research/flicek/user/rimoldi/Projects/EDM/Revisions/Enhancers_avgProfiles/Mouse_Liver_MethMatrix.txt")
rat_enh <- read.table("/nfs/research/flicek/user/rimoldi/Projects/EDM/Revisions/Enhancers_avgProfiles/Rat_Liver_MethMatrix.txt")
dog_enh <- read.table("/nfs/research/flicek/user/rimoldi/Projects/EDM/Revisions/Enhancers_avgProfiles/Dog_Liver_MethMatrix.txt")


pl_Macaque_enh <- make_plots(dog_enh, "Macaque", "H3K27ac")
pl_Mouse_enh <- make_plots(dog_enh, "Mouse", "H3K27ac")
pl_Rat_enh <- make_plots(dog_enh, "Rat", "H3K27ac")
pl_Dog_enh <- make_plots(dog_enh, "Dog", "H3K27ac")

enh_meth <-
  plot_grid(
    pl_Macaque_enh[[2]] +coord_cartesian(ylim = c(10,90)) + theme( plot.title = element_blank(), axis.title = element_blank(), axis.text.x = element_blank() ),
    pl_Mouse_enh[[2]] +coord_cartesian(ylim = c(10,90)) + theme( plot.title = element_blank(), axis.title = element_blank(), axis.text = element_blank()),
    pl_Rat_enh[[2]] +coord_cartesian(ylim = c(10,90))+ theme( plot.title = element_blank(), axis.title = element_blank(),axis.text = element_blank()),
    pl_Dog_enh[[2]] +coord_cartesian(ylim = c(10,90))+ theme( plot.title = element_blank(), axis.title = element_blank(),axis.text = element_blank()),
    nrow = 1, rel_widths = c(1,0.7,0.7,0.7)
  )

enh_cpg <-
  plot_grid(
    pl_Macaque_enh[[1]] + coord_cartesian(ylim = c(0.010, 0.028)) ,
    pl_Mouse_enh[[1]] +theme(axis.text = element_blank()) + coord_cartesian(ylim = c(0.010, 0.028) ) ,
    pl_Rat_enh[[1]] +theme(axis.text = element_blank()) + coord_cartesian(ylim = c(0.010, 0.028)) ,
    pl_Dog_enh[[1]] +theme(axis.text = element_blank()) + coord_cartesian(ylim = c(0.010, 0.028)) ,
    nrow = 1, rel_widths = c(1,0.7,0.7,0.7)
  )



Enh_cpgAndmeth_profiles <- plot_grid( enh_cpg, enh_meth, ncol=1)
Enh_cpgAndmeth_profiles
```
...
for (sp in c("Human", "Macaque","Mouse","Rat","Dog") ) {
    for ( tf in c("CEBPA", "CTCF", "HNF4a", "HNF6", "FoxA1") ) {
        ...
        colnames(tmp.results)=c("TF", "Species", "Clusters", "RegRegion", "p.value")
...
```{r fig.width=15,fig.height=5, echo=FALSE, error=TRUE, eval=FALSE}
sel <- selected %>%
  drop_na("Clusters") %>% 
  group_by(Clusters,TF,Species) %>%
  add_count(name="clustCount") %>%
...
```{r fig.width=7,fig.height=5, echo=FALSE, error=TRUE, eval=FALSE}
sel_noCTCF <- selected %>%
  drop_na("Clusters") %>% 
  group_by(Clusters,TF,Species) %>%
  add_count(name="clustCount") %>%
...
```{r fig.width=15,fig.height=18, echo=FALSE, error=TRUE}
 ...
 rr_plot <- RegReg %>%
  filter(RegRegion !="noOverlap") %>%
  left_join(., results) %>% 
  mutate(sign=if_else(p.value.adj<0.05, "*", "")) %>% 
    mutate(Clusters=factor(Clusters, rev(c("flat","right","left", "middle","up", "NC"))),
           RegRegion=factor(RegRegion, c("Promoters", "Enhancers", "primedEnhancers"))) %>% 
    ggplot( aes(x=Clusters , y=Fraction, fill=Clusters, alpha=RegRegion))+
    coord_flip()+
...
#ggsave(plot = rr_plot, filename = "/nfs/research/flicek/user/rimoldi/Projects/EDM/Figures/RegRegions_byCluster_all.pdf",width=163, height = 96, unit="mm")
```
...
palfinal <- c(rep(brewer.pal(5,"Pastel2"),23)) # temporary 21
#length(palfinal) , fill=palfinal
names(pal) <- c("up",  "middle",  "left", "right", "flat" )
fillScale <- scale_fill_manual(name = "Clusters",values = pal)
colScale <- scale_colour_manual(name = "Clusters",values = pal)

palette<-c("#009966", "#CC3399", "#99CC33", "#6666CC", "#CC6600" )
names(palette)<-c("flat","middle", "up", "left" , "right" )
colScale <- scale_colour_manual(name = "Clusters",values = palette)
```
...
TSSdist<-ggplot(tab, aes(x=DistanceTSS,colour=Clusters))+
    ...
    scale_x_continuous(trans="log10", labels = label_number( suffix = "k", scale = 1e-3, big.mark = ","))+
    theme_custom+
    facet_grid(TF~Species, scales="free")
TSSdist

ggsave(plot = TSSdist, filename = "/nfs/research/flicek/user/rimoldi/Projects/EDM/Figures/TSSdistance_byCluster_all_log.pdf",width=20, height = 35)

```

```{r fig.width=15, fig.height=7}
sel <- tab %>% 
  filter( (TF=="CEBPA" & Species=="Rat") |
          (TF=="CTCF" & Species=="Macaque") |
          (TF=="FoxA1" & Species=="Mouse")) %>% 
...
```{r}
meth_frag <- tab %>% 
  ggplot( aes(x=Clusters, fill=MethFrag)) +
  geom_bar(position="fill" )+
  scale_fill_manual(values = c("red2", "orange1", "yellow"))+
  coord_flip()+
  theme_custom +
  facet_grid(TF~Species, scales="free")

ggsave(plot = meth_frag, filename = "/nfs/research/flicek/user/rimoldi/Projects/EDM/Figures/MethFrag_clusters_allSp_allTFs.pdf",width=142, height = 100, unit="mm")
```
